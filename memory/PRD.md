...
## Hero + Navbar visual redesign (2026-08-26)
- Navbar (home-only component): dark navy TEXTURED brand bar (navy-900/95 + reused hero gradient + subtle brand/radsafe glows, border-b white/10). Logo in white rounded chip (BrandMark dark). Nav links light (slate-300). Contact Us = white pill, navy text. Mobile toggle white; mobile menu panel dark navy with white links; Z Assist/RadSafe pills recolored (emerald-300/cyan-300) for dark bg. Unaffected on /z-assist & /radsafe (navbar returns null there).
- Hero: dark bg removed -> clean light #F1F6FC (matches Brands, seamless). Removed dark ambient layers. Tagline now on ALL breakpoints: "Technology We Trust." (navy-900) / "Protection We Need." (brand blue #0052FF) with a light PayAssist pill. Video shown COMPLETE 16:9 (object-contain, no crop) in a rounded/shadowed frame, responsive width (max-w 560 -> 4xl -> 6xl). Removed unused .h-hero-mobile CSS.
- Verified 1440/1280/768/430/390/375/360: dark navbar, light hero, tagline visible both lines, video aspect ~1.78 uncropped, no overflow, dark mobile menu, /z-assist & /radsafe unchanged. Production build passes.

## Three targeted updates (2026-08-26)
1. Hero headline: "Protection We Need." recolored from brand blue -> navy-900 (#0B132B, the navbar background navy). "Technology We Trust." unchanged. Both lines now dark navy.
